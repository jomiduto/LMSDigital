  ...
  >
    ...
    <main>
        ...
        <section class="py-20 lg:py-25 xl:py-30">
            ...
            >
                {{-- @include('layouts.partials.section-title') --}}
                <div class="animate_top mx-auto max-w-1390 text-center px-4 md:px-8 xl:px-0">
                    <h2 x-text="sectionTitle" class="font-semibold text-3xl xl:text-title-xl text-black dark:text-white md:w-4/5 xl:w-1/2 mx-auto mb-4.5">Latest Blogs & News
                    </h2>
                    <p class="mx-auto md:w-4/5 lg:w-3/5 xl:w-[46%]" x-text="sectionTitleText">It is a long established fact that a reader will be distracted by the readable content of page when looking at its layout. The point of using.</p>
                </div>
            </div>
            <!-- Section Title End -->
